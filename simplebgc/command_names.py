...
UNDOCUMENTED_COMMAND_NAMES = {
    ...
    CMD_CALIB_ENCODER_LUT: 'CMD_CALIB_ENCODER_LUT',
    CMD_CALIB_ENCODER_LUT_RES: 'CMD_CALIB_ENCODER_LUT_RES',
    CMD_WRITE_PARAMS_SET: 'CMD_WRITE_PARAMS_SET',
    CMD_CALIB_CUR_SENS: 'CMD_CALIB_CUR_SENS',
    CMD_CONTROL_EXT: 'CMD_CONTROL_EXT',
    CMD_ENC_INT_CALIB: 'CMD_ENC_INT_CALIB',
    CMD_SYNC_MOTORS: 'CMD_SYNC_MOTORS',
    CMD_EXT_LICENSE_INFO: 'CMD_EXT_LICENSE_INFO',
    CMD_VIBRATION_TEST_START_STOP: 'CMD_VIBRATION_TEST_START_STOP',
    CMD_VIBRATION_TEST_DATA: 'CMD_VIBRATION_TEST_DATA',
    CMD_CAN_DRV_TELEMETRY: 'CMD_CAN_DRV_TELEMETRY',
    CMD_EXT_MOTORS_ACTION: 'CMD_EXT_MOTORS_ACTION',
    CMD_EXT_MOTORS_CONTROL: 'CMD_EXT_MOTORS_CONTROL',
    CMD_EXT_MOTORS_CONTROL_CONFIG: 'CMD_EXT_MOTORS_CONTROL_CONFIG',
    CMD_EXT_MOTORS_STATE: 'CMD_EXT_MOTORS_STATE',
    CMD_ADJ_VARS_INFO: 'CMD_ADJ_VARS_INFO',
    CMD_SERVO_OUT_EXT: 'CMD_SERVO_OUT_EXT',
    CMD_CONTROL_QUAT: 'CMD_CONTROL_QUAT',
    CMD_CONTROL_QUAT_STATUS: 'CMD_CONTROL_QUAT_STATUS',
    CMD_CONTROL_QUAT_CONFIG: 'CMD_CONTROL_QUAT_CONFIG',
    CMD_EXT_SENS_CMD: 'CMD_EXT_SENS_CMD',
    CMD_TRANSPARENT_SAPI: 'CMD_TRANSPARENT_SAPI',
}
